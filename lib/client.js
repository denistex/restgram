...
module.exports.getFullUser = user_id => { // eslint-disable-line camelcase
  return gState.client.users.getFullUser(user_id)
}
...
module.exports.importContacts = (contacts, replace) => {
  return gState.client.contacts.importContacts(contacts, replace)
}
